    ...
    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <div class="hidden flex-col items-center justify-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">The image URL may have expired</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                <a
                                    ...
                                    download="generated-image-{{ now()->format('Y-m-d-H-i') }}.jpg"
                                    target="_blank"
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">How to Get Better Results</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc list-inside space-y-1">
                            <li><strong>Be Specific:</strong> Instead of "a car", try "a vintage red 1965 Ford Mustang convertible parked on a coastal highway at sunset"</li>
                            <li><strong>Describe the Scene:</strong> Include lighting, mood, setting, and atmosphere</li>
                            <li><strong>Use Quality Terms:</strong> The system automatically adds professional quality enhancements</li>
                            <li><strong>Choose the Right Style:</strong> Photorealistic for real photos, Digital Art for modern designs, Watercolor for artistic effects</li>
                            <li><strong>Example Good Prompt:</strong> "A serene mountain landscape at golden hour, misty valleys, dramatic lighting, peaceful atmosphere, nature photography"</li>
                            <li><strong>What to Avoid:</strong> Use negative prompts for text, watermarks, blurry images, low quality, unwanted objects</li>
                        </ul>
                    </div>
                </div>
            </div>
