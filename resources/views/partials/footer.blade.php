        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex gap-4">
                    <a href="https://www.facebook.com/pioneermissionsafrica" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[var(--color-pma-green)] hover:text-white transition-all duration-300">
                    ...
                    <a href="https://www.youtube.com/@pioneermissionsafrica3344" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[var(--color-pma-green)] hover:text-white transition-all duration-300">
                    ...
                    <a href="https://open.spotify.com/artist/1WJPk0nqgN8pBPqXUk1Wjj" target="_blank" rel="noopener noreferrer" aria-label="Spotify" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#1DB954] hover:text-white transition-all duration-300">
                    ...
                    <a href="https://music.apple.com/za/artist/pma-worship/1865116757" target="_blank" rel="noopener noreferrer" aria-label="Apple Music" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FA243C] hover:text-white transition-all duration-300">
                    ...
                    <a href="https://music.youtube.com/channel/UCb5kpOoNiwCCAFgFm76oNTQ" target="_blank" rel="noopener noreferrer" aria-label="YouTube Music" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:text-white transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 50 50" fill="currentColor">
