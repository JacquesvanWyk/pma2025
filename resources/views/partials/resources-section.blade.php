...
<section class="py-20 lg:py-32 relative" style="background: white;">
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-2 gap-6 lg:gap-8 max-w-3xl mx-auto">
            <a href="{{ route('resources.tracts') }}"
               class="pma-card text-center p-8 group pma-animate-on-scroll pma-stagger-1">
                <div class="w-20 h-20 mx-auto mb-4 rounded-full flex items-center justify-center transition-all"
                ...
                <h3 class="pma-heading text-xl mb-2" style="color: var(--color-indigo);">Tracts</h3>
                <p class="pma-body text-sm" style="color: var(--color-olive);">Gospel literature</p>
            </a>

            <a href="{{ route('resources.ebooks') }}"
               class="pma-card text-center p-8 group pma-animate-on-scroll pma-stagger-2">
                <div class="w-20 h-20 mx-auto mb-4 rounded-full flex items-center justify-center transition-all"
                ...
                <h3 class="pma-heading text-xl mb-2" style="color: var(--color-indigo);">E-Books</h3>
