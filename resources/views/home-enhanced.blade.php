...
@section('content')
    ...
    <section class="pma-hero">
        ...
        <!-- Organic Blobs -->
        <div class="pma-blob" style="top: 10%; left: 10%; width: 400px; height: 400px; background: var(--color-ochre);"></div>
        <div class="pma-blob" style="bottom: 20%; right: 15%; width: 300px; height: 300px; background: var(--color-olive);"></div>
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="pma-card-elevated p-8 lg:p-12 mb-12 max-w-3xl mx-auto">
                    ...
                    <div class="flex justify-between items-baseline mb-6">
                        ...
                        <span class="pma-display text-5xl lg:text-6xl" style="color: var(--color-ochre);">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-2 mb-3">
                            <span class="px-3 py-1 rounded-full text-xs pma-heading-light"
                                  style="background: var(--color-ochre); color: white;">
                                {{ $study->category->name }}
                            </span>
    ...
    {{-- Continue with the rest of the sections using similar enhanced styling --}}
    {{-- I'll keep the remaining sections from the original file but can update them similarly --}}
