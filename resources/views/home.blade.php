                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="pma-animate-on-scroll">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="{{ route('prayer-room.index') }}" class="pma-btn pma-btn-primary">
                                <svg class="h-5 w-5 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                </svg>
                                Learn More & Submit Requests
                            </a>
                            <a href="https://chat.whatsapp.com/EqqJGyKQm02KSaYoi6RhiN?mode=hqrt1" target="_blank" class="pma-btn pma-btn-secondary bg-white text-green-600 border-white hover:bg-gray-50">
                                <svg class="h-5 w-5 inline mr-2" fill="currentColor" viewBox="0 0 24 24">
