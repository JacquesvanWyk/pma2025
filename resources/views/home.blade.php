...
@section('content')
    {{-- Album Launch Hero - Featured prominently for the REAL album release --}}
    @include('partials.album-hero')

    {{-- Monthly Pledge Section --}}
    @include('partials.pledge-section')

    <!-- Mission Section -->
    <section class="py-20 bg-[var(--color-cream)]">
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                <span class="text-[var(--color-ochre)] font-semibold uppercase tracking-widest text-sm mb-4 block">Our Mission</span>
                <h2 class="text-4xl lg:text-5xl font-bold text-[var(--color-indigo)] leading-tight mb-6">
                    Proclaiming the Everlasting Gospel in Africa and Beyond
                </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('sermons') }}" class="px-8 py-4 bg-[var(--color-indigo)] hover:bg-[var(--color-indigo-dark)] text-white rounded-xl font-semibold transition-all hover:-translate-y-1 flex items-center justify-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
