            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        @if($featuredAlbum->isReleased())
                            <a href="{{ route('music.show', $featuredAlbum->slug) }}#downloads"
                               class="px-6 py-3 bg-white border-2 border-[var(--color-pma-green)] text-[var(--color-pma-green)] hover:bg-[var(--color-pma-green)] hover:text-white rounded-xl font-semibold transition-all hover:-translate-y-1 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
